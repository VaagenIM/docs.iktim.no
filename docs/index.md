...
Dette er en digital fagbok administrert av Sondre Grønås. Ønsker du å bidra, vennligst ta kontakt, eller foreslå endringer på GitHub. Eventuelt så finner du min kontaktinfo nederst til høyre på siden.
...
- [ ] Cloud Computing
	- [ ] Azure
		- [X] Oppsett ([[IKT/2 Data/Cloud computing/Azure/index|Azure]], [[06 Docker og Wordpress|Azure med Docker og Wordpress]])
	- [ ] Docker
- [ ] JavaScript
- [ ] Firebase?
- [ ] SQL
