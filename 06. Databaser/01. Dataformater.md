# Dataformater
Når vi sender mye data mellom maskiner, bruker man ofte et eget format som er egnet for større mengder data. En av de vanligste formatene som er brukt, er [JSON](../Ordliste/JSON.md).

## JSON
Forklaring kommer! I Python bruker vi blant annet JSON formatet når vi lager [Dictionaries](../04.%20Programmering/Python/Funksjoner/02%20Dictionaries.md).
